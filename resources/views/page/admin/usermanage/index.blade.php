...
@section('content')
    ...
    <button type="button" class="btn bg-gradient-success fa-solid fas fa-user-plus" data-bs-toggle="modal"
            data-bs-target="#ADMIN">&nbsp เพิ่มผู้ดูแลระบบ
    ...
    <div class="nav-wrapper position-relative end-0">
        <ul class="nav nav-pills nav-fill p-1" id="tabs-icons-text" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1" id="tabs-icons-text-2-tab" data-bs-toggle="tab" href="#tabs-icons-text-2"
            ...
            <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1" id="tabs-icons-text-3-tab" data-bs-toggle="tab" href="#tabs-icons-text-3"
                   role="tab" aria-controls="code" aria-selected="false">
                                ...
                                @foreach ($admin as $row)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModalSignUser{{ $row->id }}"
                    ...
                    @foreach ($users as $row)
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <button type="button" class="fas fa-edit fa-lg btn btn-primary"
                                        data-bs-toggle="modal" data-bs-target="#exampleModalSignUp{{ $row->id }}">
                                ...
                                <a href="{{ url('/usermanage/delete/' . $row->id) }}"
                                   ...
                                   onclick="return confirm('ลบหรือไม่ ?')"> </a>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalSignUp{{ $row->id }}" tabindex="-1"
                    ...
                    @foreach ($insider as $row)
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <a href="{{ url('/usermanage/delete/' . $row->id) }}"
                                   class="fas fa-trash-alt fa-lg btn btn-danger"
                                   onclick="return confirm('ลบหรือไม่ ?')" disabled> </a>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalSignUp{{ $row->id }}" tabindex="-1"
                                     role="dialog" aria-labelledby="exampleModalSignTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
