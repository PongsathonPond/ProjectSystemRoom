...
<head>
    ...
    <title>
        Location Request RMUTI For STAFF
    </title>
    <!--     Fonts and icons     -->
    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @if (request()->routeIs('calendar-staff'))


                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('calendar-staff') }}">
                            <div
                                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                            </div>
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('calendar-staff') }}">
                            <div
                                    class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                            </div>
                ...
                @if (request()->routeIs('staff_history_index') || request()->routeIs('staff_history_req'))
                    <li class="nav-item">
                        <a class="nav-link bg-primary active" href="{{ route('staff_history_index') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('staff_history_index') }}">
                            <div
                                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
