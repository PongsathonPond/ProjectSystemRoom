    ...
    <aside
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @if (request()->routeIs('indexuser'))
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('indexuser') }}">
                            <div
        ...
        <div class="sidenav-footer mx-3 ">
            ...
            @if (!empty(session('student_id')))
                <a href="https://lrm.rmuti.ac.th/sso/?logout&redirect="
                    class=" btn btn-warning btn-sm mb-0 w-100  ">ออกจากระบบบัญชีมหาลัย</a>
            @else
